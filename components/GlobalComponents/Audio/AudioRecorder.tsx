...
const AudioRecorder = ({ isOpen, setIsOpen, sendFile }: AudioRecordDto) => {
    const [isPlay, setIsPlay] = useState(false);
    const [isStarted, setIsStarted] = useState(false);
    const [mediaUrl, setMediaUrl] = useState<any[]>([]);
    const { clearBlobUrl, error, isAudioMuted, mediaBlobUrl, muteAudio, pauseRecording, previewAudioStream, resumeRecording, startRecording, status, stopRecording, unMuteAudio } = useReactMediaRecorder({ audio: true })
