...
const TopNavSection = () => {
    const { openFilter, setOpenFilter, isCardView, setIsCardView, setRows, rows, search, setSearch, selectedTab, setSelectedTab, setCreateBookMark} = useContext<BookMarkContextDto>(BookMarkContext)
    return (
        <div className='w-full pt-2'>
            ...
            <PaginationTopSection setRows={setRows} setSearch={setSearch} search={search} rows={rows} isStatus={true} />
